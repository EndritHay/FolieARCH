...
function App() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Sidebar */}
      <motion.div
        className="fixed right-0 top-0 h-screen w-64 bg-dark/95 backdrop-blur-lg border-l border-white/10 z-40 shadow-2xl"
        initial={{ x: '100%' }}
      ...
      >
        <div className="flex flex-col h-full py-20 px-4">
          ...
          <div className="pt-4 border-t border-white/10">
            <motion.div
              className="text-white/50 text-sm px-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      <div ref={containerRef} className="min-h-screen">
            ...
            >
              ...
              >
                <div className="space-y-6">
                  ...
                  <motion.button
                    className="btn btn-secondary w-full group text-white"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
        ...
        <footer className="bg-dark text-white py-8 relative overflow-hidden">
          ...
          <div className="container relative">
            ...
            <motion.div 
              className="upArrow flex flex-col items-end cursor-pointer hover:scale-110 transition-transform duration-300"
